# Play Generator ( Romeo and Juliet )
...
print(text[:250])
# Preprocess (  Encoding )
# Since this text isn't encoded yet well need to do that ourselves. We are going to encode each unique character
...
for input_example_batch, target_example_batch in data.take(1):
    ...
    print(len(pred))
    print(pred)
    # notice this is a 2d array of length 100, where each interior array is the prediction for the next character
    # at each time step
